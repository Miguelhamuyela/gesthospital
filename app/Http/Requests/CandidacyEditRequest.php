...
class CandidacyEditRequest extends FormRequest
{
    /**
    ...
    public function rules()
    {
        return [
            ...
            'doc_qualification' => 'nullable|mimes:jpg,png,jpeg,pdf|file|max:6048',
            'doc_iban' => 'nullable|mimes:jpg,png,jpeg,pdf|file|max:6048',
            'photo' => 'nullable|mimes:jpg,png,jpeg|file|max:6048',
