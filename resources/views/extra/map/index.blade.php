                ...
                <div>
                    ...
                    <xml version="1.0" encoding="UTF-8" standalone="no" ?="">
                        <svg xmlns:dc="http://purl.org/dc/elements/1.1/" xmlns:cc="http://creativecommons.org/ns#"
                            ...
                            version="1.1"
                            style="border-radius:20px; padding: 20px; background-color:#ffffff; width:100%;shape-rendering:geometricPrecision; text-rendering:geometricPrecision; image-rendering:optimizeQuality; fill-rule:evenodd; clip-rule:evenodd"
                            viewBox="0 0 19647 23144" id="svg45" sodipodi:docname="mapa_angola.svg"
                            ...
                            <sodipodi:namedview pagecolor="#ffffff" bordercolor="#ffffff" borderopacity="1"
                                objecttolerance="10" gridtolerance="10" guidetolerance="10" inkscape:pageopacity="0"
                                inkscape:pageshadow="2" inkscape:window-width="1366" inkscape:window-height="715"
                                id="namedview47" showgrid="false" inkscape:zoom="0.46161663" inkscape:cx="374.06999"
                                inkscape:cy="350.90907" inkscape:window-x="-8" inkscape:window-y="-8"
                                inkscape:window-maximized="1" inkscape:current-layer="Layer_x0020_1">
                            </sodipodi:namedview>
                            <defs id="defs4">
                            ...
                            <g id="Layer_x0020_1" transform="translate(126.70434,-549.05225)">
                                ...
                                <g id="g1687">
                                    <a href="{{ route('site.candidacy.verify') }}" data-toggle="tooltip" data-html="true"
                                        data-placement="auto"
                                        title="Agentes de campo: 1 578">
                                        <path class="province"
                                    ...
                                    <a href="{{ route('site.candidacy.verify') }}" data-toggle="tooltip" data-html="true"
                                        data-placement="auto" title="Agentes de campo: 2 938">
                                        <path class="province"
                                    ...
                                    <a href="{{ route('site.candidacy.verify') }}" data-toggle="tooltip" data-html="true"
                                        data-placement="auto" title="Agentes de campo: 6 454">
                                        <path class="province"
                           ...
                           Sul" id="text17443"
                                    ...
                                    <g aria-label="Cuanza
Norte" transform="rotate(-34.216167,114.63933,13.657161)"
                                        id="text17443-2"
