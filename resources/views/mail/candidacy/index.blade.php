        ...
        <tbody>
            <tr style="vertical-align: top">
                <td style="word-break: break-word;border-collapse: collapse !important;vertical-align: top">
                                                                ...
                                                                <tr>
                                                                    <td class="v-text-align"
                                                                        ...
                                                                        <img align="center" border="0"
                                                                            src="{{ route('site.home') }}/images/logotipo/logo.png"
                                                    ...
                                                    <tr>
                                                        <td style="overflow-wrap:break-word;word-break:break-word;padding:10px;font-family:'Open Sans',sans-serif;"
                                                            ...
                                                            <div class="v-text-align"
                                                                ...
                                                                <p style="font-size: 14px; line-height: 140%;">
                                                                    <strong><span
                                                                            style="font-size: 14px; line-height: 19.6px;">{{ $candidacy['fullname'] }}</span></strong>
                                                                </p>
                                                            </div>
                                                    ...
                                                    <tr>
                                                        <td style="overflow-wrap:break-word;word-break:break-word;padding:10px;font-family:'Open Sans',sans-serif;"
                                                            ...
                                                            <div class="v-text-align"
                                                                ...
                                                                <p style="font-size: 14px; line-height: 140%;">
                                                                    <strong><span
                                                                            style="font-size: 14px; line-height: 19.6px;">Comprovativo de Inscrição:</span></strong>
                                                                </p>
                                                                <p style="font-size: 14px; line-height: 140%;">
                                                                    <span
                                                                       ...
                                                                       <a target="_blank"
                                                                       href="{{ route('site.candidacy.proof', $candidacy->bi) }}">
                                                                       Clique aqui para baixar o Comprovativo de Candidatura></a>
                                                                    </span>
                                                                </p>
                                                            </div>
                                                    ...
                                                    <tr>
                                                        <td style="overflow-wrap:break-word;word-break:break-word;padding:10px;font-family:'Open Sans',sans-serif;"
                                                            ...
                                                            <div class="v-text-align"
                                                                ...
                                                                <p style="font-size: 14px; line-height: 140%;">
                                                                    <strong><span
                                                                            style="font-size: 14px; line-height: 19.6px;">NOTA:</span></strong>
                                                                </p>
                                                                <p style="font-size: 14px; line-height: 140%;">
                                                                    <span
                                                                        style="font-size: 14px; line-height: 19.6px;">
                                                                        ...
                                                                        <b>1.</b> Disponibilidade imediata e a tempo inteiro para participar nas formações e na recolha de dados, incluindo o final de semana e feriados; <br><br>
                                                                        <b>2.</b> Ser residente e conhecer bem a zona geográfica para a qual se candidata;<br><br>
                                                                        <b>3.</b> Conhecer bem a língua local é uma vantagem;<br><br>
                                                                        <b>4.</b> O IBAN deve estar associado ao nome do Candidato, não será aceito IBAN em nome de outra pessoa; <br><br>
                                                                        <b>5.</b> Será automaticamente desqualificado se prestou falsas declarações!<br><br>
                                                                        <b>6.</b> O prazo para a correção da candidatura é de até 48 horas. <br><br>
                                                                        <b>7.</b> Pode Editar a candidatura no menu "Minha Candidatura".
                                                                    </span>
                                                                </p>
                                                            </div>
                    ...
                    <div class="u-row-container" style="padding: 0px;background-color: transparent">
                        <div class="u-row"
                            style="Margin: 0 auto;min-width: 320px;max-width: 600px;overflow-wrap: break-word;word-wrap: break-word;word-break: break-word;background-color: #FF9500;">
                            <div
                                style="border-collapse: collapse;display: table;width: 100%;background-color: transparent;">
                                <!--[if (mso)|(IE)]><table width="100%" cellpadding="0" cellspacing="0" border="0"><tr><td style="padding: 0px;background-color: transparent;" align="center"><table cellpadding="0" cellspacing="0" border="0" style="width:600px;"><tr style="background-color: #FF9500;"><![endif]-->
