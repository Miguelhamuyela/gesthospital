                    ...
                    <div style="text-align:justify;" class="col-md-12 text-justify my-5">
                        ...
                        <div class="row">
                            <p class="mt-3">
                                ...
                                Condições de
                                Utilização,
                                destina-se a regular o processo de tratamento de dados pessoais a realizar pelo INE por
                                conta da
                                utilização
                                deste website. <br>
                            ...
                            <br><br>
                            O INE não efetuará o tratamento de dados pessoais que revelem a origem racial ou étnica, as
                            opiniões
                            ...
                            <p class="mt-3">
                                ...
                                O INE dará o seu consentimento prévio relativamente à recepção de comunicações comerciais
                                para fins
                                de
                                marketing, sendo-lhe conferida a
                                faculdade de oposição, a todo o tempo, mediante comunicação escrita dirigida ao INE. <br>
                                As referidas informações comerciais, poderão ser enviadas pelo INE, através de correio
                                eletrónico,
                                telefone, SMS
                            ...
                            <p class="mt-3">
                                ...
                                protecção dos seus próprios interesses, o INE não partilhará quaisquer dados pessoais com
                                entidades
                                terceiras.
                            </p>
                            <p class="mt-3">
                            ...
                            <p class="mt-3">
                                <b>Cookies</b><br>
                                O INE poderá utilizar cookies no seu website com o objectivo de melhorar a qualidade do
